...
**If-you-do-nothing:** the principle stands as written; its mechanical enforcement is a separate backlog task (2026-07-22-provenance-checks-for-instruction-files) that won't start on its own

You directed the addition in chat ("directly generate a principle file" for
clearly-good findings); what needs your eyes is the specific scope — whether the
five listed paths are the right trust boundary, and whether binding `autonomous`
