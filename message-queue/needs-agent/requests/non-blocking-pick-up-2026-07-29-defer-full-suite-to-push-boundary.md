# Pick up Give the commit gate a routine lane and let the push boundary own completeness
...
**Full context:** `tasks/0_backlog/2026-07-29-defer-full-suite-to-push-boundary/task.md`
