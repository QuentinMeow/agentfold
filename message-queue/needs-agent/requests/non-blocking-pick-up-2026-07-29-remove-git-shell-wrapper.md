# Pick up Isolate child Git configuration by environment instead of a shell wrapper
...
**Full context:** `tasks/0_backlog/2026-07-29-remove-git-shell-wrapper/task.md`
