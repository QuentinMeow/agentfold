...
# Pick up the routine test-budget investigation

**Status:** open
**Filed:** 2026-07-27, by test-budget filer, from task `2026-07-27-investigate-routine-test-budget-0d79a10895`
...
**Full context:** `tasks/0_backlog/2026-07-27-investigate-routine-test-budget-0d79a10895/task.md`
...
**Resolution evidence:** `tasks/1_in-progress/2026-07-27-investigate-routine-test-budget-0d79a10895/task.md`
...
The `routine` gate exceeded the target stored in `testing.routine.target_seconds`. The linked task owns the timing evidence and updates.
