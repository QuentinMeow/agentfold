# Pick up the retry-filing automation and waivers task
...
**Full context:** `tasks/0_backlog/2026-07-22-retry-filing-automation-and-waivers/task.md`
**Request kind:** task-pickup
**If unanswered:** The task remains unclaimed in backlog; no current work is blocked.

## What you need to know

This task gives reconciler retries an automatic trigger and defines a durable waiver
path for findings an agent rejects.
