# Pick up the coordination-write rules task
...
**Full context:** `tasks/0_backlog/2026-07-22-finalize-coordination-write-rules/task.md`
**Request kind:** task-pickup
**If unanswered:** The task remains unclaimed in backlog; no current work is blocked.

## What you need to know

This task resolves the remaining race between main-branch coordination records and task
