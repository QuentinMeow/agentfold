# Pick up Select repository tests from the staged paths that can affect them
...
**Full context:** `tasks/0_backlog/2026-07-29-select-tests-by-input-ownership/task.md`
