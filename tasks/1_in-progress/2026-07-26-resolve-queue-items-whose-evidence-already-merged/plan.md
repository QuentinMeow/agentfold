...
- [x] 8. Record full verification and the two blocked independent review rounds, including an explicit per-method pre-repair test matrix; repair every accepted finding.
