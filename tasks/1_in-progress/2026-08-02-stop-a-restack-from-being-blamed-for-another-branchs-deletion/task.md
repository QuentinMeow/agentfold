...
**Queue actions:** `message-queue/needs-agent/requests/future-blocking-resume-v15-production-contract-review.md`; `message-queue/needs-agent/requests/non-blocking-track-github-issue-75-restack-provenance.md`
