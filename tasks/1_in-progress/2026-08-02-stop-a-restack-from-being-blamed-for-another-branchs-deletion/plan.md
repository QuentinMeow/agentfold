# Plan — Stop a restack from being blamed for another branch's deletion

- [x] 1. Build a disposable Git scenario matrix that separates legitimate inherited resolution, missing resolution evidence, and genuine old-tip action loss.
...
- [x] 4. Record the selected discriminator, supplier-support repair, adapter boundary, resource budgets, and rejected alternatives in `design.md`, including the core-fit receipt.
