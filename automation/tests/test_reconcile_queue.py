...
class ReconcileQueueTests(unittest.TestCase):
    ...
    def test_entry_schema_rank_is_monotone(self):
        self.assertEqual(0, RECONCILE.entry_schema_rank(None))
        self.assertEqual(0, RECONCILE.entry_schema_rank("v0"))
        self.assertLess(
            RECONCILE.entry_schema_rank("v1"),
            RECONCILE.entry_schema_rank("v2"),
        )
        self.assertLess(
            RECONCILE.entry_schema_rank("v2"),
            RECONCILE.entry_schema_rank("v3"),
        )
