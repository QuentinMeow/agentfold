...
- [Live queue obligations only weaken with boundary or provider evidence](decisions/2026-07-23-live-queue-obligations-only-weaken-with-evidence.md) — Live timing only escalates, future boundaries survive renames, and a provider source's final binding remains until trusted release evidence
...
- [Requested review changes route through an agent repair before re-review](decisions/2026-07-23-requested-review-changes-route-through-agent-repair.md) — A changes-requested review creates one agent-owned repair and a distinct artifact-pending human re-review at the same boundary
